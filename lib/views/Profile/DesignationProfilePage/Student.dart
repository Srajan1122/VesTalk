                   ...
                   Row(children: <Widget>[
                     ...
                     Container(
                       ...
                       decoration: BoxDecoration(
                           image: DecorationImage(
                             fit: BoxFit.cover,
                               image: AssetImage('images/ProfilePage/Profile.jpg')
                           )
                       ),
                     ),)
                   ],),
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Text('Aniket Gupta',style: TextStyle(
                            fontWeight: FontWeight.bold,
                            fontSize: 20.0
                          ),),
                          Text('2018.aniket.gupta@ves.ac.in',style: TextStyle(
                              fontSize: 14.0
                          ),),
                          ...
                          Row(
                            children: <Widget>[
                              Text('INFT,',style: TextStyle(
                                  fontSize: 14.0
                              ),),
                              Text('  2nd YEAR',style: TextStyle(
                                  fontSize: 14.0
                              ),),
...
//                                MaterialPageRoute(builder: (context) => Details(designation: "Student")));
                            Navigator.of(context)
                                .pushReplacement(MaterialPageRoute(builder: (context) => Details(designation: "Student")));
                          },
                        )
                    )
                  ],
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(width: double.infinity,height: 100.0,
                        child: Container(
                          ...
                          child:Padding(
                            padding: new EdgeInsets.fromLTRB(10.0, 2.0, 10.0, 2.0),
                            child: Text('Hello everyone I am intrested in AI and ML please contact me for startup',style: TextStyle( fontSize: 15.0),),
                          ),
                        ),)
                    ],
