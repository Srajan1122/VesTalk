                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                Text('Pooja Shety',style: TextStyle(
                                ...
                                Text('Pooja.shety@ves.ac.in',style: TextStyle(
                                    fontSize: 14.0
                                ),),
...
//                                MaterialPageRoute(builder: (context) => Details(designation: "Teacher")));
                                ...
                                Navigator.of(context)
                                    .pushReplacement(MaterialPageRoute(builder: (context) => Details(designation: "Teacher")));
                                },
                              )
                          )
                        ],
